...
CREATE TABLE `stockage` (
  `StockageID` int(11) NOT NULL AUTO_INCREMENT,
  `Adresse` varchar(50) NOT NULL,
  `Date` date NOT NULL,
  `Nom` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`StockageID`)
...
INSERT INTO `stockage` VALUES (70,'UML3NET.jpg','2014-06-15','UML3NET.jpg'),(71,'UMLCubbyHole.jpg','2014-06-15','UMLCubbyHole.jpg'),(72,'Cubbyhole.war','2014-06-16','Cubbyhole.war');
