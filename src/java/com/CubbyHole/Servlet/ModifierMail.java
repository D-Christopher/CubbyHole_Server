 ...
 * @author Christopher
 */
@WebServlet(name = "ModifierMail", urlPatterns = {"/Auth/ModifierMail"})
public class ModifierMail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        this.getServletContext().getRequestDispatcher("/WEB-INF/Auth/ModifierMail.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        client.setEmail(request.getParameter("ModifEmail"));
