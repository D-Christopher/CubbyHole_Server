 ...
 * @author Christopher
 */
@WebServlet(name = "Plan", urlPatterns = {"/Auth/Plan"})
public class Plan extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<com.CubbyHole.Entite.Plan> planList = planDao.getAllPlan();
        request.setAttribute("plan", planList);
        
        this.getServletContext().getRequestDispatcher("/WEB-INF/Auth/Offres.jsp").forward(request, response);
    }
